...
{	Trans *T;
	...
	trans[1][1]	= settr(12,0,5,3,3,"wantQ = 1", 1, 2, 0);
	...
	trans[1][2]	= settr(13,0,8,4,0,"(!(wantP))", 1, 2, 0);
	trans[1][3]	= settr(14,0,8,1,0,"goto :b3", 0, 2, 0);
	trans[1][4]	= settr(15,0,5,2,0,"else", 0, 2, 0);
	trans[1][7]	= settr(18,0,8,1,0,"break", 0, 2, 0);
	trans[1][8]	= settr(19,0,9,5,5,"wantQ = 0", 1, 2, 0);
	...
	trans[0][1]	= settr(0,0,5,7,7,"wantP = 1", 1, 2, 0);
	...
	trans[0][2]	= settr(1,0,8,8,0,"(!(wantQ))", 1, 2, 0);
	trans[0][3]	= settr(2,0,8,1,0,"goto :b1", 0, 2, 0);
	trans[0][4]	= settr(3,0,5,2,0,"else", 0, 2, 0);
	trans[0][7]	= settr(6,0,8,1,0,"break", 0, 2, 0);
	trans[0][8]	= settr(7,0,9,9,9,"wantP = 0", 1, 2, 0);
