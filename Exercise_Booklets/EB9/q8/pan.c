...
short src_ln1 [] = {
	  0,  27,  30,  30,  30,  31,  30,  32, 
	 32,  32,  34,  32,  35,  35,  35,  35, 
	 35,  35,  35,  36,  35,  34,  37,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "q8.pml", 1, 22 },
	{ "-", 23, 24 }
...
short src_ln0 [] = {
	  0,  11,  13,  14,  16,  16,  15,  18, 
	 15,  18,  12,  20,   9,  21,   9,  21, 
	 22,  25,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "q8.pml", 1, 17 },
...
{	int j = 0, h = now._nr_pr;
	...
	case 0:	/* P */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->myId = (((int)((P0 *)_this)->_pid)-1);
		((P0 *)pptr(h))->left = ((((int)((P0 *)_this)->myId)+2)%3);
		((P0 *)pptr(h))->right = ((((int)((P0 *)_this)->myId)+1)%3);
#ifdef VAR_RANGES
