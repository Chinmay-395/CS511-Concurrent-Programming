...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC user */
	case 3: // STATE 1 - q5.pml:6 - [flag[_pid] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - q5.pml:7 - [turn = _pid] (0:0:1 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 3 - q5.pml:10 - [(((flag[(1-_pid)]==0)||(turn==(1-_pid))))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!(((((int)now.flag[ Index((1-((int)((P0 *)_this)->_pid)), 2) ])==0)||(((int)now.turn)==(1-((int)((P0 *)_this)->_pid))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 4 - q5.pml:10 - [counter = (counter+1)] (0:0:1 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 11 - q5.pml:16 - [assert((counter==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][11] = 1;
		spin_assert((((int)now.counter)==1), "(counter==1)", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 12 - q5.pml:17 - [counter = (counter-1)] (0:0:1 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		(trpt+1)->bup.oval = ((int)now.counter);
		now.counter = (((int)now.counter)-1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 13 - q5.pml:19 - [flag[_pid] = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		(trpt+1)->bup.oval = ((int)now.flag[ Index(((int)((P0 *)_this)->_pid), 2) ]);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 14 - q5.pml:20 - [assert((counter==0))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][14] = 1;
		spin_assert((((int)now.counter)==0), "(counter==0)", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 15 - q5.pml:21 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][15] = 1;
